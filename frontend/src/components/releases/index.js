// src/components/releases/index.js
...
export { default as ReleaseChangelog } from "./ReleaseChangelog";
...
export { default as MilestoneStats } from "./MilestoneStats";
export { default as MilestoneCard } from "./MilestoneCard";
export { default as BulkUpdateProgress } from "./BulkUpdateProgress";
